...
class SearchCouponContent(BaseDto):
    ...
    member_grade_nos: list[int] | None = Field(None, description="발급 대상 회원등급 번호 리스트")
    member_group_nos: list[int] | None = Field(None, description="발급 대상 회원그룹 번호 리스트")
...
class IssuableConstraint(BaseDto):
    ...
    member_grade_nos: list[int] | None = Field(None, description="발급대상 회원등급 리스트")
    member_group_nos: list[int] | None = Field(None, description="발급대상 회원그룹 리스트")
